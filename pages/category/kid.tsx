...
const KidPage: NextPage = () => {
  ...
  return (
    <ShopLayout title={'TGlobal-Market - Kids'} pageDescription={'Encuentra los mejores productos de Global Market para niños'}>
...
const KidPage: NextPage = () => {
  ...
  const [product, setProduct] = useState(inicio);
    ...
    useEffect(()=>{
        setProduct(initialData.products.filter(i=>i.gender === 'kid'));
        setRespaldo(initialData.products.filter(i=>i.gender === 'kid'))
    },[]);
    const next = ()=>{
